  ...
  return (
    <>
      ...
      <form
        ...
        className="flex w-full md:w-auto flex-col sm:flex-row gap-3 sm:gap-4 items-stretch sm:items-center"
      ...
      >
         <input
          ...
          className="w-full sm:w-80 h-12 px-4 rounded-md bg-white/10 border border-white/10 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-white/30 transition-shadow duration-300 font-sans"
        />
        ...
        <Button
          variant="secondary"
          disabled={submitted}
          className="w-full md:w-[120px]  hover:bg-white/90 font-medium "
          size="lg"
